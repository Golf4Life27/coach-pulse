  ...
  return {
    ...
    external_signals: {
      ...
      vercel: {
        ...
        production_deploy_url: "coach-pulse-test.vercel.app",
        ...
        production_deploy_branch: "claude/maverick-aggregator",
        production_deploy_ready_at: "2026-05-15T02:38:00Z",
        production_deploy_created_at: "2026-05-15T02:37:00Z",
        ...
        active_deals: [
          {
            ...
            status: "Negotiating",
            list_price: 95000,
            outreach_offer_price: 61750,
            offer_price: 61750,
            contract_offer_price: null,
